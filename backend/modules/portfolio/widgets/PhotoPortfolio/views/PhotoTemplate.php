<div style="margin-bottom: 10px; margin-right: 50px;"> 
    <?php
        $sTitleMaxLength = 'Max length is ' . Yii::app()->params['lengthPortfolioTitle'] . ' symbols';
        $sDescMaxLength = 'Max length is ' . Yii::app()->params['lengthPortfolioDescription'] . ' symbols';
    ...
    <!--<div class="control-group">
        ...
        <div class="controls" style="margin-left: 100px;">
            <?php //echo TbHtml::activeTextField($model, 'title', array('name' => $baseName.'[title]', 'span' => 3, 'placeholder'=>'portfolio title')); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls" style="margin-left: 100px;">
            <?php  //echo TbHtml::activeTextField($model, 'description', array('name' => $baseName . '[description]', 'span' => 8, 'placeholder'=>'portfolio description')); ?>
        </div>
    </div>-->
    ...
    <div class="<?=$checkBoxClass?>">
        <?php echo TbHtml::activeLabelEx($model, 'is_active', array('class'=>'fl-l w-100', 'style'=>'margin-right: 10px;'));
            echo TbHtml::activeCheckBox($model, 'is_active', array(
                ...
                'placeholder'=>'portfolio is_active',
            )); ?>
    </div>
