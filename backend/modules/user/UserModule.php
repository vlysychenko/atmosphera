...
class UserModule extends CWebModule
{
	...
	public $loginUrl = '/user/login'; //array("/user/login");
	public $logoutUrl = array("/user/logout");
	public $profileUrl = array("/user/profile");
	public $returnUrl = array("/user/profile");
	public $returnLogoutUrl = '/user/login'; //array("/user/login");
    public $adminUrl = 'user/admin';
	...
	public function init()
	{
        ...
        $this->returnLogoutUrl = Yii::app()->createAbsoluteUrl("/user/login");
        $this->adminUrl = Yii::app()->createAbsoluteUrl("/user/admin");
        $this->loginUrl = Yii::app()->createAbsoluteUrl("/user/login");
	}
