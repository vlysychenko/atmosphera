...
class ProfileFieldController extends Controller
{
	...
	public function registerScript() {
		$basePath=Yii::getPathOfAlias('common.modules.user.views.asset');
	 ...
	 */
	protected function loadProfileModel()
	{
		if($this->_model===null)
		{
			if(isset($_GET['id']))
	...
	public static function getWidgets($fieldType='') {
		$basePath=Yii::getPathOfAlias('common.modules.user.components');
		$widgets = array();
