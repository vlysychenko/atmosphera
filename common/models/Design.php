...
class Design extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('anounce, publication_date, user_id, category', 'required'),
            ...
            array('post_id, anounce, publication_date, is_top, is_slider, user_id, category', 'safe', 'on'=>'search'),
    ...
    //function after delete design record
    ...
    /**
     * defaultScope for Design selecting
     *
     */
