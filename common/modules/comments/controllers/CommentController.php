...
class CommentController extends CController
{
	...
	/*public function filters()
	{
		return array(
			'accessControl', // perform access control for CRUD operations
                        'ajaxOnly + PostComment, Delete, Approve, Cancel',
		);
	}*/
	...
	/*public function accessRules()
	{
		return array(
			...
			array('allow',
				'actions'=>array('admin', 'delete', 'approve', 'cancel'),
    ...
    {
        $result = array('restoredID' => $id);
        if($this->loadModel($id)->setRestored())
            $result['code'] = 'success';
        else 
            $result['code'] = 'fail';
        echo CJSON::encode($result);
    ...
    {
        $result = array('cancelledID' => $id);
        if($this->loadModel($id)->setCancelled())
            $result['code'] = 'success';
        else 
            $result['code'] = 'fail';
        echo CJSON::encode($result);
