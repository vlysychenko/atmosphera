...
return array(
    ...
    'Update Time'=>'Дата редактирования',
    'Status'=>'Статус сообщения',
    'Verification Code'=>'Код проверки',
    //диалоговое окно
    'Add comment'=>'Добавить комментарий',
    'Delete this comment?'=>'Удалить комментарий?',
    'Approve this comment?'=>'Утвердить комментарий?',
    'Cancel'=>'Отмена',
    //админ страница
    'Manage Comments'=>'Управление комментариями',
    'Manage'=>'Управления',
    'Commented object'=>'Комментируемый объект',
    'Commented object\'s ID'=>'ID комментируемого объекта',
    'New'=>'Новый',
    'Approved'=>'Утвержден',
    'Deleted'=>'Удален',
    'Link'=>'Ссылка',
    //added by php-monsters group
    'Object' => 'Объект',
    'Status' => 'Статус',
    'Cancel this comment?'=>'Отменить комментарий?',
    'Restore this comment?'=>'Восстановить комментарий?',
    'Answer' => 'Ответить',
);
?>