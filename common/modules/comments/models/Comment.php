...
class Comment extends CActiveRecord {
    ...
    public function rules() {
        ...
        $rules = array(
            array('owner_name, owner_id, comment_text, user_name', 'required'),
...
//            }
    ...
    public function getStatuses()
    {
        ...
        return array(
            self::STATUS_NOT_APPROVED=>Yii::t('CommentsModule.msg','New'),
            self::STATUS_APPROVED=>Yii::t('CommentsModule.msg','Approved'),
            self::STATUS_DELETED=>Yii::t('CommentsModule.msg','Deleted')
        );
    }
    ...
    public function beforeSave() {
        ...
        if($this->isNewRecord === true && 
            ($this->config['premoderate'] === false || $this->evaluateExpression($this->config['isSuperuser']) === true))
            $this->status = self::STATUS_APPROVED;
