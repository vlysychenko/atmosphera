...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?php if(Yii::app()->user->isGuest == true):?>
        <div class="row">
            <?php echo $form->labelEx($newComment, 'user_name', array('class'=>'comment-label')); ?>
            <?php echo $form->textField($newComment,'user_name', array('size'=>40)); ?>
            <?php echo $form->error($newComment,'user_name'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($newComment, 'user_email', array('class'=>'comment-label')); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($newComment, 'comment_text', array('class'=>'comment-label')); ?>
