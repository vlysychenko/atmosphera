            ...
            <div class="main-nav">
                <div class="header-block">
                    <ul class="social">
                        ...
                        <li><a class="fb" href="<?= $links['facebook'] ? 'http://' . $links['facebook'] : '' ?>">Facebook</a>
                        </li>
                    </ul>
                </div>
                <span></span>
                <ul class="menu">
                    <li><a href="<?= Yii::app()->createAbsoluteUrl('design') ?>"><?= Yii::t('main', 'DESIGN') ?></a>
                    </li>
                    <li><a href="<?= Yii::app()->createAbsoluteUrl('portfolio') ?>"><?= Yii::t(
                                'main',
                                'PORTFOLIO'
                            ) ?></a></li>
                    <!--                        <li><a href="-->
                    <? //=Yii::app()->createAbsoluteUrl('partners')?><!--">-->
                    <? //=Yii::t('main','partners')?><!--</a></li>-->
                    <li><a href="<?= Yii::app()->createAbsoluteUrl('about') ?>"><?= Yii::t('main', 'about us') ?></a>
                    </li>
                    <li><a href="<?= Yii::app()->createAbsoluteUrl('blogs') ?>"><?= Yii::t('main', 'blogs') ?></a></li>
                    <li><a href="<?= Yii::app()->createAbsoluteUrl('contacts') ?>"><?= Yii::t('main', 'contacts') ?></a>
                    </li>
                </ul>
            </div>
        </div>
...
<!--            </div>-->
            ...
            <!--                    <a style="color: #FFFFFF; position: relative; left: 160px;" href="-->
            <? //=Yii::app()->createAbsoluteUrl('sitemap')?><!--">Карта сайта</a>-->
            <!--                </div>-->
        </div>
    </div>
</div>
